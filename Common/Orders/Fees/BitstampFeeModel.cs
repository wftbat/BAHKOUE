...
namespace QuantConnect.Orders.Fees
{
    ...
    public class BitstampFeeModel : FeeModel
    {
        ...
        {
            (0m,          0.0000m, 0.0000m),
            (1000m,       0.0030m, 0.0040m),
            (10000m,      0.0020m, 0.0030m),
            (100000m,     0.0010m, 0.0020m),
            (500000m,     0.0008m, 0.0018m),
            (1500000m,    0.0006m, 0.0016m),
            (5000000m,    0.0003m, 0.0012m),
            (20000000m,   0.0002m, 0.0010m),
            (50000000m,   0.0001m, 0.0008m),
            (100000000m,  0.0000m, 0.0006m),
            (250000000m,  0.0000m, 0.0005m),
            (1000000000m, 0.0000m, 0.0003m)
        };
