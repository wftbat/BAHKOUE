...
namespace MyIA.Trading.Backtester
{
	...
	public class TradingStrategy : TradingStrategyBase
	{
	    ...
	    [ConditionalVisible("TradingBandDirection", false, true, new object[] { MyIA.Trading.Backtester.TradingBandDirection.Inwards }), ExtendedCategory("Expressions")]
	    ...
	    [ConditionalVisible("TradingBandDirection", false, true, new object[] { MyIA.Trading.Backtester.TradingBandDirection.Outwards }), ExtendedCategory("Expressions")]
			...
			set
			{
				if (value != this._ordersDistribution)
				{
					...
					switch (value)
					{
						...
						case MyIA.Trading.Backtester.OrdersDistribution.Exponential:
						{
